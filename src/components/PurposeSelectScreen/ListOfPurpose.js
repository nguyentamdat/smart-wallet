    ...
    if (tabPage === 0) {
      if (this.state.isAllSelected_E === false) {
        ...
        purposes = purposes.concat(
          this.state.listPurpose.filter(purpose => purpose.isRevenue === false)
        );
        this.setState({
      ...
      if (this.state.isAllSelected_R === false) {
        ...
        purposes = purposes.concat(
          this.state.listPurpose.filter(purpose => purpose.isRevenue === true)
        );
        this.setState({
          purposeInList: purposes
        });
          ...
          <Tab
            heading={
              <TabHeading>
                ...
                <Text style={{ textTransform: "uppercase" }}>chi tiền</Text>
              </TabHeading>
            }
          >
          ...
          <Tab
            heading={
              <TabHeading>
                ...
                <Text style={{ textTransform: "uppercase" }}>thu tiền</Text>
              </TabHeading>
            }
          >
        ...
        {!this.state.isSingleSelect && (
          <Footer style={styles.footer}>
            <Button
              ...
              onPress={() => this._handleSelectAll(this.state.tabPage)}
            >
              <Icon type="MaterialCommunityIcons" name="select-all" />
              {((!this.state.isAllSelected_E && this.state.tabPage === 0) ||
                (!this.state.isAllSelected_R && this.state.tabPage === 1)) && (
